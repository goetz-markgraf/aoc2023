...
mod tests {
    ...
    #[test]
    fn test_solve1_test() {
        let test = solution_lines("day1_test", solve1, 142);
        assert!(test);
    }

    #[test]
    fn test_solve1() {
        let test = solution_lines("day1", solve1, 55130);
        assert!(test);
    }

    #[test]
    fn test_solve2_test() {
        let test = solution_lines("day1_test2", solve2, 281);
        assert!(test);
    }

    #[test]
    fn test_solve2() {
        let test = solution_lines("day1", solve2, 54985);
        assert!(test);
    }
}
